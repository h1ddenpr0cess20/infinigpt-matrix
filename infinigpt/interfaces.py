...
class LLMClientProtocol(Protocol):
    """Protocol describing the expected LLM client interface."""
    async def chat(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...


class MatrixClientProtocol(Protocol):
    """Protocol describing the Matrix client wrapper contract."""
...
class HistoryStoreProtocol(Protocol):
    """Protocol describing the history store operations used by handlers."""
